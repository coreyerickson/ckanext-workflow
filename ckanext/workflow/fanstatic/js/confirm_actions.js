/*
* This module handles confirmation of deactivation, reactiation, delete actions
* on user's dashbord and organization datasets. 
*/



this.ckan.module('confirm_actions', function (jQuery, _) {
  return {
    ...
    performAction: function () {
      // create a form and submit hit to confirm the deletion
      var form = document.getElementById("form_action_filter");
      form.action = this.options.url_action;
      form.submit();
    },
    ...
    createModal: function () {
      if (!this.modal) {
        ...
        element.find('.modal-body').text(this.options.i18n.content);
